...
/**
 * {@priyanawal CustomAnalyzer} that includes logic from StandardAnalyzer and EnglishAnalyzer.
 */
public final class GeneralisedCustomAnalyzer extends StopwordAnalyzerBase {
  ...
  public GeneralisedCustomAnalyzer() {
    this(ENGLISH_STOP_WORDS_SET);
  }
  
  public GeneralisedCustomAnalyzer(CharArraySet stopwords) {
    this(stopwords, CharArraySet.EMPTY_SET);
  }

  public GeneralisedCustomAnalyzer(CharArraySet stopwords, CharArraySet stemExclusionSet) {
    super(stopwords);
